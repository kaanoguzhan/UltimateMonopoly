...
public class Debug extends JFrame {
	...
	public Debug() {
		...
		btnSetLoc2.addActionListener(al -> {
		...
		Player2.add(lblNeuLands2);
		
		JButton btnRemoveLnd2 = new JButton("Remove");
		btnRemoveLnd2.addActionListener(al -> {
		...
		btnClaimLnd2.addActionListener(al -> {
		...
		btnSetLoc3.addActionListener(al -> {
		...
		Player3.add(lblNeuLands3);
		
		JButton btnRemoveLnd3 = new JButton("Remove");
		btnRemoveLnd3.addActionListener(al -> {
		...
		btnClaimLnd3.addActionListener(al -> {
		...
		Player4.add(btnSetMon4);
		
		JButton btnMin4 = new JButton("-");
		btnMin4.addActionListener(al -> {
