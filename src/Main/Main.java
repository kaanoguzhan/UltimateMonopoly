...
public class Main {
	...
	private static void initializeGameSquares() {
		...
		gameSquares[59] = new Land(59, "Kýrby Drive", color.lightYellow, 180, 14).addDeedInfo(70, 200, 550, 750, 950,
				1450, 80, 100);
		gameSquares[60] = new Land(60, "Cullen Bouleward", color.lightYellow, 180, 14).addDeedInfo(70, 200, 550, 750,
				950, 1450, 80, 100);
