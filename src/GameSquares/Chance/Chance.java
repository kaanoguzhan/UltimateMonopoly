...
public class Chance extends GameSquare {
	...
	public enum ChanceCardType {
		AdvanceToSqueezePlay, AdvanceToStart, AdvanceToStCharlesPlace, AdvanceToTheNearestRailroad, AdvanceToTheNearestUtility, ElectedAsChairPerson, GeneralRepairs, GetOutOfJail, GoToJail, Hurricane, MargiGras, PropertyTaxes, SchoolFees, ThreeSpacesBack
	}
