...
public class CommunityChestDeck {
	...
	private CommunityChestCard[] cards = { new BargainBusiness(), new BargainBusiness(), new RecieveConsultancyFee(),
			new RecieveConsultancyFee(), new RenovationSuccess(), new RenovationSuccess(), };
